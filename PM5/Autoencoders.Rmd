...
# Need to have a compatible version of tensorflow
...
# Need to have scikit-learn installed in the python environment that reticulate uses
# py_install("scikit-learn")
# conda_update() # Make sure python environment is up to date
# reticulate::conda_install(envname = "r-reticulate", packages = "numpy=1.22.0", channel = "conda-forge") # get numpy version compatible with sklearn version
